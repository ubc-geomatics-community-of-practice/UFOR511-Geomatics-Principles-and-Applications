...
The final dataset (Landuse 2016) can be found on the course management system. This shapefile was downloaded from Metro Vancouver's Open Data Catalogue; however, at least two of the polygons had errors and needed to be edited for the analysis to work properly.
